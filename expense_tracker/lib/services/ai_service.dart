...
class AiService {
  ...
  Future<Map<String, dynamic>?> processExpenseText(
    String text,
  ) async {
    try {
      ...
      print(
        'An unexpected error occurred during text processing: $e',
      );
      return null;
    }
  }
  ...
  Future<String?> transcribeVoiceExpense(
    String audioPath,
  ) async {
    try {
      var request = http.MultipartRequest(
      ...
      print(
        "Uploading voice recording for transcription...",
      );
      var streamedResponse = await request.send().timeout(
      ...
      if (response.statusCode == 200) {
        ...
        print(
          "Failed to transcribe voice: ${response.body}",
        );
        return null;
      }
    } on TimeoutException {
      ...
      print(
        'Error connecting to AI service for voice transcription: $e.',
      );
      return null;
    } catch (e) {
      print(
        "An unexpected error occurred during voice transcription: $e",
      );
      return null;
    }
  }
